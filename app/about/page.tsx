      ...
      <div className="container py-16">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-semibold mb-3">Our Collections</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-semibold mb-3">Our Growth</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="text-center p-6 rounded-xl bg-secondary/50">
            <div className="text-4xl mb-4">🎨</div>
            <h3 className="text-xl font-semibold mb-2">Contemporary Design</h3>
            <p className="text-muted-foreground">
