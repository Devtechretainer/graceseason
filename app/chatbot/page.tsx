...
export default function ChatbotPage() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hi there! I'm Daman-GPT, your personal style assistant. How can I help you today?",
      timestamp: new Date(),
    },
  ])
      ...
      <header className="sticky top-0 z-10 backdrop-blur-md bg-black/50 border-b border-zinc-800">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-xl">Daman-GPT</h1>
            ...
            >
              ...
              <div className="pt-4 border-t border-zinc-800">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-medium">Daman-GPT</h3>
                    <p className="text-xs text-zinc-400">Powered by AI</p>
                  </div>
                </div>
                <p className="text-xs text-zinc-400">
                  Daman-GPT is your personal style assistant, designed to help you discover and refine your fashion
                  sense.
                </p>
              </div>
            </motion.div>
