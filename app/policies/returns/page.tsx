      ...
      <div className="bg-secondary/30 rounded-lg p-8 space-y-6">
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 text-muted-foreground space-y-3">
            <li>
              ...
              <Link href="mailto:returns@graceseason.com" className="underline hover:text-primary ml-1">
                returns@graceseason.com
              </Link>{" "}
            ...
            <li>
              <strong className="text-foreground">Ship the item back:</strong> Package the item securely and ship it
        ...
        <section>
          ...
          <p className="text-muted-foreground">
            ...
            incorrect or defective item). If the return is due to our error, we will provide a prepaid shipping label.
          </p>
        </section>
