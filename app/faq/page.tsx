        ...
        <div className="bg-secondary/30 rounded-lg p-8">
          <Accordion className="space-y-4">
            ...
            <AccordionItem title="How can I use the Style Assistant?">
              <p>
                Our Style Assistant (Daman-GPT) can help you find the perfect outfit or styling advice. Simply click on
            ...
            <AccordionItem title="Can I sell my clothes to Grace Season?">
              <p>
